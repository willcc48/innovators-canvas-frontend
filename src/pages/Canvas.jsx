...
class Canvas extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://innovators-canvas-backend.herokuapp.com/userinfo', {withCredentials: true})
            .then(res => {
                var data = res.data;
                if(data.netid) {
    ...
    updateInfo() {
        ...
        xhr.open('POST', 'https://innovators-canvas-backend.herokuapp.com/canvas_data', true);
    ...
    constructDragDBArray(id) {
        var dragArray, secHeight, secWidth;
        switch(id) {
            case 'stress':
